        ...
        headers: [
          {
            ...
            value: [
              ...
              "font-src 'self' data:",
              "connect-src 'self' http://localhost:8000 https://brandalyze.onrender.com https://*.clerk.accounts.dev https://clerk.brandalyze.io https://clerk-telemetry.com https://tally.so wss://*.clerk.accounts.dev wss://clerk.brandalyze.io https://cloud.umami.is https://api-gateway.umami.dev",
